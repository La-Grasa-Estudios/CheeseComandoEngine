...
#define Z_INFO_DEBUG(...) Z_INFO(__VA_ARGS__)
#define Z_WARN_DEBUG(...) Z_WARN(__VA_ARGS__)
#define Z_ERROR_DEBUG(...) Z_ERROR(__VA_ARGS__)
...
BEGIN_ENGINE
	...
	protected:
		...
		const char* Format(LogLevel level);
