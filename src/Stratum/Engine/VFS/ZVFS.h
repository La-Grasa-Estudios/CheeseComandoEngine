...
public:
	...
	inline static bool g_VFSDebug = false;

	static void Init();

	static void Mount(std::string directory);
	static void Mount(std::string directory, bool root);
	...
	static std::vector<std::string> GetAllOf(const char* extension);
